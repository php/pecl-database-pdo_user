/* Generated by re2c 0.12.3 on Tue Oct 30 10:56:07 2007 */
...
#line 277 "pdo_user_sql_tokenizer.re"
		{ RET(PU_LABEL); }
#line 346 "pdo_user_sql_tokenizer.c"
yy5:
		++YYCURSOR;
...
#line 273 "pdo_user_sql_tokenizer.re"
		{ RET(PU_WHITESPACE); }
#line 387 "pdo_user_sql_tokenizer.c"
yy7:
		yych = *++YYCURSOR;
		if(yych <= 'N') {
...
#line 257 "pdo_user_sql_tokenizer.re"
		{ RET(PU_PLUS); }
#line 706 "pdo_user_sql_tokenizer.c"
yy36:
		yyaccept = 0;
...
#line 258 "pdo_user_sql_tokenizer.re"
		{ RET(PU_MINUS); }
#line 716 "pdo_user_sql_tokenizer.c"
yy38:
		++YYCURSOR;
#line 259 "pdo_user_sql_tokenizer.re"
		{ RET(PU_MUL); }
#line 721 "pdo_user_sql_tokenizer.c"
yy40:
		++YYCURSOR;
#line 260 "pdo_user_sql_tokenizer.re"
		{ RET(PU_DIV); }
#line 726 "pdo_user_sql_tokenizer.c"
yy42:
		++YYCURSOR;
#line 261 "pdo_user_sql_tokenizer.re"
		{ RET(PU_MOD); }
#line 731 "pdo_user_sql_tokenizer.c"
yy44:
		++YYCURSOR;
#line 262 "pdo_user_sql_tokenizer.re"
		{ RET(PU_LPAREN); }
#line 736 "pdo_user_sql_tokenizer.c"
yy46:
		++YYCURSOR;
#line 263 "pdo_user_sql_tokenizer.re"
		{ RET(PU_RPAREN); }
#line 741 "pdo_user_sql_tokenizer.c"
yy48:
		++YYCURSOR;
#line 264 "pdo_user_sql_tokenizer.re"
		{ RET(PU_COMMA); }
#line 746 "pdo_user_sql_tokenizer.c"
yy50:
		++YYCURSOR;
...
#line 266 "pdo_user_sql_tokenizer.re"
		{ RET(PU_SEMICOLON); }
#line 756 "pdo_user_sql_tokenizer.c"
yy54:
		++YYCURSOR;
...
#line 267 "pdo_user_sql_tokenizer.re"
		{ RET(PU_DOT); }
#line 764 "pdo_user_sql_tokenizer.c"
yy56:
		++YYCURSOR;
		if(yybm[0+(yych = *YYCURSOR)] & 32) {
			goto yy70;
		}
#line 268 "pdo_user_sql_tokenizer.re"
		{ RET(PU_COLON); }
#line 772 "pdo_user_sql_tokenizer.c"
yy58:
		++YYCURSOR;
...
#line 276 "pdo_user_sql_tokenizer.re"
		{ RET(PU_LNUM); }
#line 821 "pdo_user_sql_tokenizer.c"
yy68:
		yyaccept = 1;
		YYMARKER = ++YYCURSOR;
...
#line 278 "pdo_user_sql_tokenizer.re"
		{ RET(PU_END); }
#line 846 "pdo_user_sql_tokenizer.c"
yy74:
		yych = *++YYCURSOR;
		if(yych <= '/') goto yy2;
		if(yych >= ':') goto yy2;
...
#line 275 "pdo_user_sql_tokenizer.re"
		{ RET(PU_DNUM); }
#line 860 "pdo_user_sql_tokenizer.c"
yy78:
		yych = *++YYCURSOR;
		if(yybm[0+yych] & 64) {
			goto yy79;
...
#line 274 "pdo_user_sql_tokenizer.re"
		{ RET(PU_HNUM); }
#line 876 "pdo_user_sql_tokenizer.c"
yy82:
		++YYCURSOR;
		if(YYLIMIT == YYCURSOR) YYFILL(1);
		yych = *YYCURSOR;
...
#line 272 "pdo_user_sql_tokenizer.re"
		{ RET_UNESC(PU_STRING); }
#line 887 "pdo_user_sql_tokenizer.c"
yy85:
		++YYCURSOR;
		if(YYLIMIT == YYCURSOR) YYFILL(1);
		yych = *YYCURSOR;
...
#line 271 "pdo_user_sql_tokenizer.re"
		{ RET_UNESC(PU_STRING); }
#line 898 "pdo_user_sql_tokenizer.c"
yy88:
		++YYCURSOR;
		if(YYLIMIT == YYCURSOR) YYFILL(1);
		yych = *YYCURSOR;
...
#line 270 "pdo_user_sql_tokenizer.re"
		{ RET_UNESC(PU_LABEL); }
#line 909 "pdo_user_sql_tokenizer.c"
yy91:
		++YYCURSOR;
		if((YYLIMIT - YYCURSOR) < 2) YYFILL(2);
		yych = *YYCURSOR;
...
#line 254 "pdo_user_sql_tokenizer.re"
		{ RET(PU_XOR); }
#line 929 "pdo_user_sql_tokenizer.c"
yy96:
		++YYCURSOR;
#line 248 "pdo_user_sql_tokenizer.re"
		{ RET(PU_GREATER_EQUAL); }
#line 934 "pdo_user_sql_tokenizer.c"
yy98:
		++YYCURSOR;
#line 247 "pdo_user_sql_tokenizer.re"
		{ RET(PU_LESSER_EQUAL); }
#line 939 "pdo_user_sql_tokenizer.c"
yy100:
		++YYCURSOR;
#line 246 "pdo_user_sql_tokenizer.re"
		{ RET(PU_UNEQUAL); }
#line 944 "pdo_user_sql_tokenizer.c"
yy102:
		++YYCURSOR;
#line 245 "pdo_user_sql_tokenizer.re"
		{ RET(PU_NOT_EQUAL); }
#line 949 "pdo_user_sql_tokenizer.c"
yy104:
		yych = *++YYCURSOR;
...
#line 242 "pdo_user_sql_tokenizer.re"
		{ RET(PU_ENUM); }
#line 965 "pdo_user_sql_tokenizer.c"
yy108:
		yych = *++YYCURSOR;
...
#line 228 "pdo_user_sql_tokenizer.re"
		{ RET(PU_YEAR); }
#line 981 "pdo_user_sql_tokenizer.c"
yy112:
		yych = *++YYCURSOR;
...
#line 239 "pdo_user_sql_tokenizer.re"
		{ RET(PU_MEDIUMBLOB); }
#line 1048 "pdo_user_sql_tokenizer.c"
yy124:
		yych = *++YYCURSOR;
...
#line 235 "pdo_user_sql_tokenizer.re"
		{ RET(PU_MEDIUMTEXT); }
#line 1064 "pdo_user_sql_tokenizer.c"
yy128:
		yych = *++YYCURSOR;
...
#line 218 "pdo_user_sql_tokenizer.re"
		{ RET(PU_MEDIUMINT); }
#line 1076 "pdo_user_sql_tokenizer.c"
yy131:
		yych = *++YYCURSOR;
...
#line 209 "pdo_user_sql_tokenizer.re"
		{ RET(PU_ZEROFILL); }
#line 1108 "pdo_user_sql_tokenizer.c"
yy139:
		yych = *++YYCURSOR;
...
#line 204 "pdo_user_sql_tokenizer.re"
		{ RET(PU_JOIN); }
#line 1124 "pdo_user_sql_tokenizer.c"
yy143:
		yych = *++YYCURSOR;
...
#line 195 "pdo_user_sql_tokenizer.re"
		{ RET(PU_PRIMARY); }
#line 1152 "pdo_user_sql_tokenizer.c"
yy150:
		yych = *++YYCURSOR;
...
#line 190 "pdo_user_sql_tokenizer.re"
		{ RET(PU_BY); }
#line 1191 "pdo_user_sql_tokenizer.c"
yy155:
		yych = *++YYCURSOR;
...
#line 237 "pdo_user_sql_tokenizer.re"
		{ RET(PU_BLOB); }
#line 1203 "pdo_user_sql_tokenizer.c"
yy158:
		++YYCURSOR;
		if(yybm[0+(yych = *YYCURSOR)] & 32) {
			goto yy70;
...
#line 213 "pdo_user_sql_tokenizer.re"
		{ RET(PU_BIT); }
#line 1211 "pdo_user_sql_tokenizer.c"
yy160:
		yych = *++YYCURSOR;
...
#line 222 "pdo_user_sql_tokenizer.re"
		{ RET(PU_BINARY); }
#line 1236 "pdo_user_sql_tokenizer.c"
yy166:
		yych = *++YYCURSOR;
...
#line 219 "pdo_user_sql_tokenizer.re"
		{ RET(PU_BIGINT); }
#line 1252 "pdo_user_sql_tokenizer.c"
yy170:
		yych = *++YYCURSOR;
...
#line 196 "pdo_user_sql_tokenizer.re"
		{ RET(PU_BEFORE); }
#line 1272 "pdo_user_sql_tokenizer.c"
yy175:
		++YYCURSOR;
		if(yybm[0+(yych = *YYCURSOR)] & 32) {
			goto yy70;
...
#line 205 "pdo_user_sql_tokenizer.re"
		{ RET(PU_ON); }
#line 1280 "pdo_user_sql_tokenizer.c"
yy177:
		++YYCURSOR;
		if((yych = *YYCURSOR) <= '^') {
			if(yych <= '@') {
...
#line 253 "pdo_user_sql_tokenizer.re"
		{ RET(PU_OR); }
#line 1303 "pdo_user_sql_tokenizer.c"
yy179:
		yych = *++YYCURSOR;
...
#line 201 "pdo_user_sql_tokenizer.re"
		{ RET(PU_OUTER); }
#line 1323 "pdo_user_sql_tokenizer.c"
yy184:
		yych = *++YYCURSOR;
...
#line 189 "pdo_user_sql_tokenizer.re"
		{ RET(PU_ORDER); }
#line 1339 "pdo_user_sql_tokenizer.c"
yy188:
		yych = *++YYCURSOR;
...
#line 188 "pdo_user_sql_tokenizer.re"
		{ RET(PU_HAVING); }
#line 1363 "pdo_user_sql_tokenizer.c"
yy194:
		yych = *++YYCURSOR;
...
#line 240 "pdo_user_sql_tokenizer.re"
		{ RET(PU_LONGBLOB); }
#line 1428 "pdo_user_sql_tokenizer.c"
yy205:
		yych = *++YYCURSOR;
...
#line 236 "pdo_user_sql_tokenizer.re"
		{ RET(PU_LONGTEXT); }
#line 1444 "pdo_user_sql_tokenizer.c"
yy209:
		yych = *++YYCURSOR;
...
#line 249 "pdo_user_sql_tokenizer.re"
		{ RET(PU_LIKE); }
#line 1461 "pdo_user_sql_tokenizer.c"
yy213:
		yych = *++YYCURSOR;
...
#line 187 "pdo_user_sql_tokenizer.re"
		{ RET(PU_LIMIT); }
#line 1473 "pdo_user_sql_tokenizer.c"
yy216:
		yych = *++YYCURSOR;
...
#line 202 "pdo_user_sql_tokenizer.re"
		{ RET(PU_LEFT); }
#line 1485 "pdo_user_sql_tokenizer.c"
yy219:
		yych = *++YYCURSOR;
...
#line 185 "pdo_user_sql_tokenizer.re"
		{ RET(PU_WHERE); }
#line 1505 "pdo_user_sql_tokenizer.c"
yy224:
		yych = *++YYCURSOR;
...
#line 183 "pdo_user_sql_tokenizer.re"
		{ RET(PU_FROM); }
#line 1526 "pdo_user_sql_tokenizer.c"
yy229:
		yych = *++YYCURSOR;
...
#line 231 "pdo_user_sql_tokenizer.re"
		{ RET(PU_FLOAT); }
#line 1542 "pdo_user_sql_tokenizer.c"
yy233:
		yych = *++YYCURSOR;
...
#line 177 "pdo_user_sql_tokenizer.re"
		{ RET(PU_NULL); }
#line 1563 "pdo_user_sql_tokenizer.c"
yy238:
		++YYCURSOR;
		if(yybm[0+(yych = *YYCURSOR)] & 32) {
			goto yy70;
...
#line 251 "pdo_user_sql_tokenizer.re"
		{ RET(PU_NOT); }
#line 1571 "pdo_user_sql_tokenizer.c"
yy240:
		yych = *++YYCURSOR;
...
#line 176 "pdo_user_sql_tokenizer.re"
		{ RET(PU_KEY); }
#line 1583 "pdo_user_sql_tokenizer.c"
yy243:
		yych = *++YYCURSOR;
		if(yych <= 'R') {
...
#line 174 "pdo_user_sql_tokenizer.re"
		{ RET(PU_VIEW); }
#line 1614 "pdo_user_sql_tokenizer.c"
yy248:
		yych = *++YYCURSOR;
...
#line 221 "pdo_user_sql_tokenizer.re"
		{ RET(PU_VARCHAR); }
#line 1655 "pdo_user_sql_tokenizer.c"
yy256:
		yych = *++YYCURSOR;
...
#line 223 "pdo_user_sql_tokenizer.re"
		{ RET(PU_VARBINARY); }
#line 1679 "pdo_user_sql_tokenizer.c"
yy262:
		yych = *++YYCURSOR;
...
#line 193 "pdo_user_sql_tokenizer.re"
		{ RET(PU_VALUES); }
#line 1695 "pdo_user_sql_tokenizer.c"
yy266:
		yych = *++YYCURSOR;
...
#line 192 "pdo_user_sql_tokenizer.re"
		{ RET(PU_TO); }
#line 1725 "pdo_user_sql_tokenizer.c"
yy271:
		yych = *++YYCURSOR;
...
#line 226 "pdo_user_sql_tokenizer.re"
		{ RET(PU_TIME); }
#line 1757 "pdo_user_sql_tokenizer.c"
yy275:
		yych = *++YYCURSOR;
...
#line 227 "pdo_user_sql_tokenizer.re"
		{ RET(PU_TIMESTAMP); }
#line 1781 "pdo_user_sql_tokenizer.c"
yy281:
		yych = *++YYCURSOR;
		if(yych <= 'T') {
			if(yych <= 'H') {
...
#line 238 "pdo_user_sql_tokenizer.re"
		{ RET(PU_TINYBLOB); }
#line 1832 "pdo_user_sql_tokenizer.c"
yy289:
		yych = *++YYCURSOR;
...
#line 234 "pdo_user_sql_tokenizer.re"
		{ RET(PU_TINYTEXT); }
#line 1848 "pdo_user_sql_tokenizer.c"
yy293:
		yych = *++YYCURSOR;
...
#line 216 "pdo_user_sql_tokenizer.re"
		{ RET(PU_TINYINT); }
#line 1860 "pdo_user_sql_tokenizer.c"
yy296:
		yych = *++YYCURSOR;
...
#line 233 "pdo_user_sql_tokenizer.re"
		{ RET(PU_TEXT); }
#line 1872 "pdo_user_sql_tokenizer.c"
yy299:
		yych = *++YYCURSOR;
...
#line 173 "pdo_user_sql_tokenizer.re"
		{ RET(PU_TABLE); }
#line 1888 "pdo_user_sql_tokenizer.c"
yy303:
		yych = *++YYCURSOR;
		if(yych <= 'O') {
...
#line 186 "pdo_user_sql_tokenizer.re"
		{ RET(PU_GROUP); }
#line 1923 "pdo_user_sql_tokenizer.c"
yy309:
		yych = *++YYCURSOR;
...
#line 167 "pdo_user_sql_tokenizer.re"
		{ RET(PU_GRANT); }
#line 1935 "pdo_user_sql_tokenizer.c"
yy312:
		yych = *++YYCURSOR;
...
#line 191 "pdo_user_sql_tokenizer.re"
		{ RET(PU_AS); }
#line 1988 "pdo_user_sql_tokenizer.c"
yy318:
		yych = *++YYCURSOR;
...
#line 2042 "pdo_user_sql_tokenizer.c"
yy332:
		++YYCURSOR;
		if(yybm[0+(yych = *YYCURSOR)] & 32) {
			goto yy70;
...
#line 206 "pdo_user_sql_tokenizer.re"
		{ RET(PU_ASC); }
#line 2050 "pdo_user_sql_tokenizer.c"
yy334:
		++YYCURSOR;
		if(yybm[0+(yych = *YYCURSOR)] & 32) {
			goto yy70;
...
#line 252 "pdo_user_sql_tokenizer.re"
		{ RET(PU_AND); }
#line 2058 "pdo_user_sql_tokenizer.c"
yy336:
		yych = *++YYCURSOR;
...
#line 179 "pdo_user_sql_tokenizer.re"
		{ RET(PU_ALL); }
#line 2071 "pdo_user_sql_tokenizer.c"
yy339:
		yych = *++YYCURSOR;
...
#line 166 "pdo_user_sql_tokenizer.re"
		{ RET(PU_ALTER); }
#line 2083 "pdo_user_sql_tokenizer.c"
yy342:
		yych = *++YYCURSOR;
...
#line 197 "pdo_user_sql_tokenizer.re"
		{ RET(PU_AFTER); }
#line 2099 "pdo_user_sql_tokenizer.c"
yy346:
		++YYCURSOR;
		if(yybm[0+(yych = *YYCURSOR)] & 32) {
			goto yy70;
...
#line 169 "pdo_user_sql_tokenizer.re"
		{ RET(PU_ADD); }
#line 2107 "pdo_user_sql_tokenizer.c"
yy348:
		yych = *++YYCURSOR;
		if(yych <= 'V') {
			if(yych <= 'M') {
...
#line 250 "pdo_user_sql_tokenizer.re"
		{ RET(PU_RLIKE); }
#line 2153 "pdo_user_sql_tokenizer.c"
yy355:
		yych = *++YYCURSOR;
...
#line 203 "pdo_user_sql_tokenizer.re"
		{ RET(PU_RIGHT); }
#line 2169 "pdo_user_sql_tokenizer.c"
yy359:
		yych = *++YYCURSOR;
...
#line 229 "pdo_user_sql_tokenizer.re"
		{ RET(PU_REAL); }
#line 2191 "pdo_user_sql_tokenizer.c"
yy364:
		yych = *++YYCURSOR;
...
#line 168 "pdo_user_sql_tokenizer.re"
		{ RET(PU_REVOKE); }
#line 2207 "pdo_user_sql_tokenizer.c"
yy368:
		yych = *++YYCURSOR;
...
#line 165 "pdo_user_sql_tokenizer.re"
		{ RET(PU_RENAME); }
#line 2223 "pdo_user_sql_tokenizer.c"
yy372:
		yych = *++YYCURSOR;
...
#line 175 "pdo_user_sql_tokenizer.re"
		{ RET(PU_COLUMN); }
#line 2277 "pdo_user_sql_tokenizer.c"
yy385:
		yych = *++YYCURSOR;
...
#line 220 "pdo_user_sql_tokenizer.re"
		{ RET(PU_CHAR); }
#line 2289 "pdo_user_sql_tokenizer.c"
yy388:
		yych = *++YYCURSOR;
...
#line 170 "pdo_user_sql_tokenizer.re"
		{ RET(PU_DROP); }
#line 2347 "pdo_user_sql_tokenizer.c"
yy396:
		yych = *++YYCURSOR;
...
#line 230 "pdo_user_sql_tokenizer.re"
		{ RET(PU_DOUBLE); }
#line 2367 "pdo_user_sql_tokenizer.c"
yy401:
		yych = *++YYCURSOR;
...
#line 199 "pdo_user_sql_tokenizer.re"
		{ RET(PU_DISTINCT); }
#line 2395 "pdo_user_sql_tokenizer.c"
yy408:
		yych = *++YYCURSOR;
...
#line 232 "pdo_user_sql_tokenizer.re"
		{ RET(PU_DECIMAL); }
#line 2434 "pdo_user_sql_tokenizer.c"
yy417:
		++YYCURSOR;
		if(yybm[0+(yych = *YYCURSOR)] & 32) {
			goto yy70;
...
#line 207 "pdo_user_sql_tokenizer.re"
		{ RET(PU_DESC); }
#line 2442 "pdo_user_sql_tokenizer.c"
yy419:
		yych = *++YYCURSOR;
...
#line 184 "pdo_user_sql_tokenizer.re"
		{ RET(PU_DEFAULT); }
#line 2462 "pdo_user_sql_tokenizer.c"
yy424:
		yych = *++YYCURSOR;
...
#line 163 "pdo_user_sql_tokenizer.re"
		{ RET(PU_DELETE); }
#line 2478 "pdo_user_sql_tokenizer.c"
yy428:
		yych = *++YYCURSOR;
...
#line 225 "pdo_user_sql_tokenizer.re"
		{ RET(PU_DATE); }
#line 2505 "pdo_user_sql_tokenizer.c"
yy431:
		yych = *++YYCURSOR;
...
#line 224 "pdo_user_sql_tokenizer.re"
		{ RET(PU_DATETIME); }
#line 2525 "pdo_user_sql_tokenizer.c"
yy436:
		yych = *++YYCURSOR;
		if(yych <= 'S') {
...
#line 162 "pdo_user_sql_tokenizer.re"
		{ RET(PU_UPDATE); }
#line 2564 "pdo_user_sql_tokenizer.c"
yy443:
		yych = *++YYCURSOR;
...
#line 208 "pdo_user_sql_tokenizer.re"
		{ RET(PU_UNSIGNED); }
#line 2597 "pdo_user_sql_tokenizer.c"
yy451:
		yych = *++YYCURSOR;
...
#line 194 "pdo_user_sql_tokenizer.re"
		{ RET(PU_UNIQUE); }
#line 2613 "pdo_user_sql_tokenizer.c"
yy455:
		yych = *++YYCURSOR;
...
#line 210 "pdo_user_sql_tokenizer.re"
		{ RET(PU_IN); }
#line 2660 "pdo_user_sql_tokenizer.c"
yy458:
		yych = *++YYCURSOR;
...
#line 214 "pdo_user_sql_tokenizer.re"
		{ RET(PU_INT); }
#line 2700 "pdo_user_sql_tokenizer.c"
yy461:
		yych = *++YYCURSOR;
...
#line 200 "pdo_user_sql_tokenizer.re"
		{ RET(PU_INNER); }
#line 2716 "pdo_user_sql_tokenizer.c"
yy465:
		yych = *++YYCURSOR;
...
#line 182 "pdo_user_sql_tokenizer.re"
		{ RET(PU_INTO); }
#line 2729 "pdo_user_sql_tokenizer.c"
yy468:
		yych = *++YYCURSOR;
...
#line 215 "pdo_user_sql_tokenizer.re"
		{ RET(PU_INTEGER); }
#line 2745 "pdo_user_sql_tokenizer.c"
yy472:
		yych = *++YYCURSOR;
...
#line 161 "pdo_user_sql_tokenizer.re"
		{ RET(PU_INSERT); }
#line 2761 "pdo_user_sql_tokenizer.c"
yy476:
		yych = *++YYCURSOR;
...
#line 198 "pdo_user_sql_tokenizer.re"
		{ RET(PU_IDENTIFIED); }
#line 2797 "pdo_user_sql_tokenizer.c"
yy485:
		yych = *++YYCURSOR;
		if(yych <= 'T') {
...
#line 217 "pdo_user_sql_tokenizer.re"
		{ RET(PU_SMALLINT); }
#line 2876 "pdo_user_sql_tokenizer.c"
yy496:
		yych = *++YYCURSOR;
...
#line 241 "pdo_user_sql_tokenizer.re"
		{ RET(PU_SET); }
#line 2889 "pdo_user_sql_tokenizer.c"
yy499:
		yych = *++YYCURSOR;
...
#line 160 "pdo_user_sql_tokenizer.re"
		{ RET(PU_SELECT); }
#line 2905 "pdo_user_sql_tokenizer.c"
	}
}
#line 279 "pdo_user_sql_tokenizer.re"
