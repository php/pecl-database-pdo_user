/* Generated by re2c 0.10.2 on Wed May 10 14:14:05 2006 */
...
#line 274 "pdo_user_sql_tokenizer.re"
		{ RET(PU_LNUM); }
#line 812 "pdo_user_sql_tokenizer.c"
yy66:
		yyaccept = 1;
		YYMARKER = ++YYCURSOR;
...
#line 276 "pdo_user_sql_tokenizer.re"
		{ RET(PU_END); }
#line 837 "pdo_user_sql_tokenizer.c"
yy72:
		yych = *++YYCURSOR;
		if(yych <= '/') goto yy2;
		if(yych >= ':') goto yy2;
...
#line 273 "pdo_user_sql_tokenizer.re"
		{ RET(PU_DNUM); }
#line 851 "pdo_user_sql_tokenizer.c"
yy76:
		yych = *++YYCURSOR;
		if(yybm[0+yych] & 64) {
			goto yy77;
...
#line 272 "pdo_user_sql_tokenizer.re"
		{ RET(PU_HNUM); }
#line 867 "pdo_user_sql_tokenizer.c"
yy80:
		++YYCURSOR;
		if(YYLIMIT == YYCURSOR) YYFILL(1);
		yych = *YYCURSOR;
...
#line 270 "pdo_user_sql_tokenizer.re"
		{ RET_UNESC(PU_STRING); }
#line 878 "pdo_user_sql_tokenizer.c"
yy83:
		++YYCURSOR;
		if(YYLIMIT == YYCURSOR) YYFILL(1);
		yych = *YYCURSOR;
...
#line 269 "pdo_user_sql_tokenizer.re"
		{ RET_UNESC(PU_STRING); }
#line 889 "pdo_user_sql_tokenizer.c"
yy86:
		++YYCURSOR;
		if(YYLIMIT == YYCURSOR) YYFILL(1);
		yych = *YYCURSOR;
...
#line 268 "pdo_user_sql_tokenizer.re"
		{ RET_UNESC(PU_LABEL); }
#line 900 "pdo_user_sql_tokenizer.c"
yy89:
		++YYCURSOR;
		if((YYLIMIT - YYCURSOR) < 2) YYFILL(2);
		yych = *YYCURSOR;
...
#line 253 "pdo_user_sql_tokenizer.re"
		{ RET(PU_XOR); }
#line 920 "pdo_user_sql_tokenizer.c"
yy94:
		++YYCURSOR;
#line 247 "pdo_user_sql_tokenizer.re"
		{ RET(PU_GREATER_EQUAL); }
#line 925 "pdo_user_sql_tokenizer.c"
yy96:
		++YYCURSOR;
#line 246 "pdo_user_sql_tokenizer.re"
		{ RET(PU_LESSER_EQUAL); }
#line 930 "pdo_user_sql_tokenizer.c"
yy98:
		++YYCURSOR;
#line 245 "pdo_user_sql_tokenizer.re"
		{ RET(PU_UNEQUAL); }
#line 935 "pdo_user_sql_tokenizer.c"
yy100:
		++YYCURSOR;
#line 244 "pdo_user_sql_tokenizer.re"
		{ RET(PU_NOT_EQUAL); }
#line 940 "pdo_user_sql_tokenizer.c"
yy102:
		yych = *++YYCURSOR;
...
#line 241 "pdo_user_sql_tokenizer.re"
		{ RET(PU_ENUM); }
#line 956 "pdo_user_sql_tokenizer.c"
yy106:
		yych = *++YYCURSOR;
...
#line 227 "pdo_user_sql_tokenizer.re"
		{ RET(PU_YEAR); }
#line 972 "pdo_user_sql_tokenizer.c"
yy110:
		yych = *++YYCURSOR;
...
#line 238 "pdo_user_sql_tokenizer.re"
		{ RET(PU_MEDIUMBLOB); }
#line 1039 "pdo_user_sql_tokenizer.c"
yy122:
		yych = *++YYCURSOR;
...
#line 234 "pdo_user_sql_tokenizer.re"
		{ RET(PU_MEDIUMTEXT); }
#line 1055 "pdo_user_sql_tokenizer.c"
yy126:
		yych = *++YYCURSOR;
...
#line 217 "pdo_user_sql_tokenizer.re"
		{ RET(PU_MEDIUMINT); }
#line 1067 "pdo_user_sql_tokenizer.c"
yy129:
		yych = *++YYCURSOR;
...
#line 209 "pdo_user_sql_tokenizer.re"
		{ RET(PU_ZEROFILL); }
#line 1099 "pdo_user_sql_tokenizer.c"
yy137:
		yych = *++YYCURSOR;
...
#line 204 "pdo_user_sql_tokenizer.re"
		{ RET(PU_JOIN); }
#line 1115 "pdo_user_sql_tokenizer.c"
yy141:
		yych = *++YYCURSOR;
...
#line 195 "pdo_user_sql_tokenizer.re"
		{ RET(PU_PRIMARY); }
#line 1143 "pdo_user_sql_tokenizer.c"
yy148:
		yych = *++YYCURSOR;
...
#line 190 "pdo_user_sql_tokenizer.re"
		{ RET(PU_BY); }
#line 1182 "pdo_user_sql_tokenizer.c"
yy153:
		yych = *++YYCURSOR;
...
#line 236 "pdo_user_sql_tokenizer.re"
		{ RET(PU_BLOB); }
#line 1194 "pdo_user_sql_tokenizer.c"
yy156:
		++YYCURSOR;
		if(yybm[0+(yych = *YYCURSOR)] & 32) {
			goto yy68;
...
#line 221 "pdo_user_sql_tokenizer.re"
		{ RET(PU_BINARY); }
#line 1227 "pdo_user_sql_tokenizer.c"
yy164:
		yych = *++YYCURSOR;
...
#line 218 "pdo_user_sql_tokenizer.re"
		{ RET(PU_BIGINT); }
#line 1243 "pdo_user_sql_tokenizer.c"
yy168:
		yych = *++YYCURSOR;
...
#line 196 "pdo_user_sql_tokenizer.re"
		{ RET(PU_BEFORE); }
#line 1263 "pdo_user_sql_tokenizer.c"
yy173:
		++YYCURSOR;
		if(yybm[0+(yych = *YYCURSOR)] & 32) {
			goto yy68;
...
#line 252 "pdo_user_sql_tokenizer.re"
		{ RET(PU_OR); }
#line 1294 "pdo_user_sql_tokenizer.c"
yy177:
		yych = *++YYCURSOR;
...
#line 189 "pdo_user_sql_tokenizer.re"
		{ RET(PU_ORDER); }
#line 1330 "pdo_user_sql_tokenizer.c"
yy186:
		yych = *++YYCURSOR;
...
#line 188 "pdo_user_sql_tokenizer.re"
		{ RET(PU_HAVING); }
#line 1354 "pdo_user_sql_tokenizer.c"
yy192:
		yych = *++YYCURSOR;
...
#line 239 "pdo_user_sql_tokenizer.re"
		{ RET(PU_LONGBLOB); }
#line 1419 "pdo_user_sql_tokenizer.c"
yy203:
		yych = *++YYCURSOR;
...
#line 235 "pdo_user_sql_tokenizer.re"
		{ RET(PU_LONGTEXT); }
#line 1435 "pdo_user_sql_tokenizer.c"
yy207:
		yych = *++YYCURSOR;
...
#line 248 "pdo_user_sql_tokenizer.re"
		{ RET(PU_LIKE); }
#line 1452 "pdo_user_sql_tokenizer.c"
yy211:
		yych = *++YYCURSOR;
...
#line 187 "pdo_user_sql_tokenizer.re"
		{ RET(PU_LIMIT); }
#line 1464 "pdo_user_sql_tokenizer.c"
yy214:
		yych = *++YYCURSOR;
...
#line 202 "pdo_user_sql_tokenizer.re"
		{ RET(PU_LEFT); }
#line 1476 "pdo_user_sql_tokenizer.c"
yy217:
		yych = *++YYCURSOR;
...
#line 185 "pdo_user_sql_tokenizer.re"
		{ RET(PU_WHERE); }
#line 1496 "pdo_user_sql_tokenizer.c"
yy222:
		yych = *++YYCURSOR;
...
#line 183 "pdo_user_sql_tokenizer.re"
		{ RET(PU_FROM); }
#line 1517 "pdo_user_sql_tokenizer.c"
yy227:
		yych = *++YYCURSOR;
...
#line 230 "pdo_user_sql_tokenizer.re"
		{ RET(PU_FLOAT); }
#line 1533 "pdo_user_sql_tokenizer.c"
yy231:
		yych = *++YYCURSOR;
...
#line 177 "pdo_user_sql_tokenizer.re"
		{ RET(PU_NULL); }
#line 1554 "pdo_user_sql_tokenizer.c"
yy236:
		++YYCURSOR;
		if(yybm[0+(yych = *YYCURSOR)] & 32) {
			goto yy68;
...
#line 176 "pdo_user_sql_tokenizer.re"
		{ RET(PU_KEY); }
#line 1574 "pdo_user_sql_tokenizer.c"
yy241:
		yych = *++YYCURSOR;
		if(yych <= 'R') {
...
#line 220 "pdo_user_sql_tokenizer.re"
		{ RET(PU_VARCHAR); }
#line 1646 "pdo_user_sql_tokenizer.c"
yy254:
		yych = *++YYCURSOR;
...
#line 222 "pdo_user_sql_tokenizer.re"
		{ RET(PU_VARBINARY); }
#line 1670 "pdo_user_sql_tokenizer.c"
yy260:
		yych = *++YYCURSOR;
...
#line 193 "pdo_user_sql_tokenizer.re"
		{ RET(PU_VALUES); }
#line 1686 "pdo_user_sql_tokenizer.c"
yy264:
		yych = *++YYCURSOR;
...
#line 192 "pdo_user_sql_tokenizer.re"
		{ RET(PU_TO); }
#line 1716 "pdo_user_sql_tokenizer.c"
yy269:
		yych = *++YYCURSOR;
...
#line 225 "pdo_user_sql_tokenizer.re"
		{ RET(PU_TIME); }
#line 1748 "pdo_user_sql_tokenizer.c"
yy273:
		yych = *++YYCURSOR;
...
#line 226 "pdo_user_sql_tokenizer.re"
		{ RET(PU_TIMESTAMP); }
#line 1772 "pdo_user_sql_tokenizer.c"
yy279:
		yych = *++YYCURSOR;
		if(yych <= 'T') {
			if(yych <= 'H') {
...
#line 237 "pdo_user_sql_tokenizer.re"
		{ RET(PU_TINYBLOB); }
#line 1823 "pdo_user_sql_tokenizer.c"
yy287:
		yych = *++YYCURSOR;
...
#line 233 "pdo_user_sql_tokenizer.re"
		{ RET(PU_TINYTEXT); }
#line 1839 "pdo_user_sql_tokenizer.c"
yy291:
		yych = *++YYCURSOR;
...
#line 215 "pdo_user_sql_tokenizer.re"
		{ RET(PU_TINYINT); }
#line 1851 "pdo_user_sql_tokenizer.c"
yy294:
		yych = *++YYCURSOR;
...
#line 232 "pdo_user_sql_tokenizer.re"
		{ RET(PU_TEXT); }
#line 1863 "pdo_user_sql_tokenizer.c"
yy297:
		yych = *++YYCURSOR;
...
#line 173 "pdo_user_sql_tokenizer.re"
		{ RET(PU_TABLE); }
#line 1879 "pdo_user_sql_tokenizer.c"
yy301:
		yych = *++YYCURSOR;
		if(yych <= 'O') {
...
#line 186 "pdo_user_sql_tokenizer.re"
		{ RET(PU_GROUP); }
#line 1914 "pdo_user_sql_tokenizer.c"
yy307:
		yych = *++YYCURSOR;
...
#line 167 "pdo_user_sql_tokenizer.re"
		{ RET(PU_GRANT); }
#line 1926 "pdo_user_sql_tokenizer.c"
yy310:
		yych = *++YYCURSOR;
...
#line 191 "pdo_user_sql_tokenizer.re"
		{ RET(PU_AS); }
#line 1979 "pdo_user_sql_tokenizer.c"
yy316:
		yych = *++YYCURSOR;
...
#line 2033 "pdo_user_sql_tokenizer.c"
yy330:
		++YYCURSOR;
		if(yybm[0+(yych = *YYCURSOR)] & 32) {
			goto yy68;
...
#line 179 "pdo_user_sql_tokenizer.re"
		{ RET(PU_ALL); }
#line 2062 "pdo_user_sql_tokenizer.c"
yy337:
		yych = *++YYCURSOR;
...
#line 166 "pdo_user_sql_tokenizer.re"
		{ RET(PU_ALTER); }
#line 2074 "pdo_user_sql_tokenizer.c"
yy340:
		yych = *++YYCURSOR;
...
#line 197 "pdo_user_sql_tokenizer.re"
		{ RET(PU_AFTER); }
#line 2090 "pdo_user_sql_tokenizer.c"
yy344:
		++YYCURSOR;
		if(yybm[0+(yych = *YYCURSOR)] & 32) {
			goto yy68;
...
#line 249 "pdo_user_sql_tokenizer.re"
		{ RET(PU_RLIKE); }
#line 2144 "pdo_user_sql_tokenizer.c"
yy353:
		yych = *++YYCURSOR;
...
#line 203 "pdo_user_sql_tokenizer.re"
		{ RET(PU_RIGHT); }
#line 2160 "pdo_user_sql_tokenizer.c"
yy357:
		yych = *++YYCURSOR;
...
#line 228 "pdo_user_sql_tokenizer.re"
		{ RET(PU_REAL); }
#line 2182 "pdo_user_sql_tokenizer.c"
yy362:
		yych = *++YYCURSOR;
...
#line 168 "pdo_user_sql_tokenizer.re"
		{ RET(PU_REVOKE); }
#line 2198 "pdo_user_sql_tokenizer.c"
yy366:
		yych = *++YYCURSOR;
...
#line 165 "pdo_user_sql_tokenizer.re"
		{ RET(PU_RENAME); }
#line 2214 "pdo_user_sql_tokenizer.c"
yy370:
		yych = *++YYCURSOR;
...
#line 164 "pdo_user_sql_tokenizer.re"
		{ RET(PU_CREATE); }
#line 2248 "pdo_user_sql_tokenizer.c"
yy378:
		yych = *++YYCURSOR;
...
#line 175 "pdo_user_sql_tokenizer.re"
		{ RET(PU_COLUMN); }
#line 2268 "pdo_user_sql_tokenizer.c"
yy383:
		yych = *++YYCURSOR;
...
#line 219 "pdo_user_sql_tokenizer.re"
		{ RET(PU_CHAR); }
#line 2280 "pdo_user_sql_tokenizer.c"
yy386:
		yych = *++YYCURSOR;
...
#line 170 "pdo_user_sql_tokenizer.re"
		{ RET(PU_DROP); }
#line 2338 "pdo_user_sql_tokenizer.c"
yy394:
		yych = *++YYCURSOR;
...
#line 229 "pdo_user_sql_tokenizer.re"
		{ RET(PU_DOUBLE); }
#line 2358 "pdo_user_sql_tokenizer.c"
yy399:
		yych = *++YYCURSOR;
...
#line 199 "pdo_user_sql_tokenizer.re"
		{ RET(PU_DISTINCT); }
#line 2386 "pdo_user_sql_tokenizer.c"
yy406:
		yych = *++YYCURSOR;
...
#line 231 "pdo_user_sql_tokenizer.re"
		{ RET(PU_DECIMAL); }
#line 2425 "pdo_user_sql_tokenizer.c"
yy415:
		++YYCURSOR;
		if(yybm[0+(yych = *YYCURSOR)] & 32) {
			goto yy68;
...
#line 184 "pdo_user_sql_tokenizer.re"
		{ RET(PU_DEFAULT); }
#line 2453 "pdo_user_sql_tokenizer.c"
yy422:
		yych = *++YYCURSOR;
...
#line 163 "pdo_user_sql_tokenizer.re"
		{ RET(PU_DELETE); }
#line 2469 "pdo_user_sql_tokenizer.c"
yy426:
		yych = *++YYCURSOR;
...
#line 223 "pdo_user_sql_tokenizer.re"
		{ RET(PU_DATETIME); }
#line 2516 "pdo_user_sql_tokenizer.c"
yy434:
		yych = *++YYCURSOR;
		if(yych <= 'S') {
...
#line 162 "pdo_user_sql_tokenizer.re"
		{ RET(PU_UPDATE); }
#line 2555 "pdo_user_sql_tokenizer.c"
yy441:
		yych = *++YYCURSOR;
...
#line 208 "pdo_user_sql_tokenizer.re"
		{ RET(PU_UNSIGNED); }
#line 2588 "pdo_user_sql_tokenizer.c"
yy449:
		yych = *++YYCURSOR;
...
#line 194 "pdo_user_sql_tokenizer.re"
		{ RET(PU_UNIQUE); }
#line 2604 "pdo_user_sql_tokenizer.c"
yy453:
		yych = *++YYCURSOR;
...
#line 213 "pdo_user_sql_tokenizer.re"
		{ RET(PU_INT); }
#line 2669 "pdo_user_sql_tokenizer.c"
yy458:
		yych = *++YYCURSOR;
...
#line 200 "pdo_user_sql_tokenizer.re"
		{ RET(PU_INNER); }
#line 2685 "pdo_user_sql_tokenizer.c"
yy462:
		yych = *++YYCURSOR;
...
#line 182 "pdo_user_sql_tokenizer.re"
		{ RET(PU_INTO); }
#line 2698 "pdo_user_sql_tokenizer.c"
yy465:
		yych = *++YYCURSOR;
...
#line 214 "pdo_user_sql_tokenizer.re"
		{ RET(PU_INTEGER); }
#line 2714 "pdo_user_sql_tokenizer.c"
yy469:
		yych = *++YYCURSOR;
...
#line 161 "pdo_user_sql_tokenizer.re"
		{ RET(PU_INSERT); }
#line 2730 "pdo_user_sql_tokenizer.c"
yy473:
		yych = *++YYCURSOR;
...
#line 198 "pdo_user_sql_tokenizer.re"
		{ RET(PU_IDENTIFIED); }
#line 2766 "pdo_user_sql_tokenizer.c"
yy482:
		yych = *++YYCURSOR;
		if(yych <= 'T') {
...
#line 216 "pdo_user_sql_tokenizer.re"
		{ RET(PU_SMALLINT); }
#line 2845 "pdo_user_sql_tokenizer.c"
yy493:
		yych = *++YYCURSOR;
...
#line 240 "pdo_user_sql_tokenizer.re"
		{ RET(PU_SET); }
#line 2858 "pdo_user_sql_tokenizer.c"
yy496:
		yych = *++YYCURSOR;
...
#line 160 "pdo_user_sql_tokenizer.re"
		{ RET(PU_SELECT); }
#line 2874 "pdo_user_sql_tokenizer.c"
	}
}
